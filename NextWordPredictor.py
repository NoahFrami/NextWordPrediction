"""
N-gram Language Model - Starter Template
...
def preprocess_text(text):
    ...
    for sentence in raw_sentences:
        ...
        #keep words and apostrophies together
...
def build_bigrams(sentences):
    ...
    """
    # Count all consecutive pairs of tokens
    bigrams = Counter()
...
def sentence_probability(sentence, bigram_probs):
    ...
    tokens = ["<s>"] + re.findall(r"[a-z0-9']+", sentence) + ["</s>"]
...
def main():
    filename = "sample_language_model_text.txt"
    ...
    sentence1 = "i want food"
    sentence2 = "food want i"
